...
**Studio Cucubits. by Sachie Kobayashi** は、  
音楽制作のためのスタジオであり、思考と実験のためのプラットフォームです。

映画、舞台、映像作品、インスタレーションなど、  
形式やジャンルにとらわれない音楽表現を軸に、  
映像、美術、テクノロジー、研究分野とのコラボレーションを展開しています。

AIをはじめとする先端技術が創作にもたらす可能性と課題に向き合いながら、  
音楽と社会、表現と問いのあいだを行き来する制作・研究を行っています。

Studio Cucubits. は、作品を生み出す場であると同時に、  
分野を越えて出会い、考え、試みるための名前です。  
音楽を起点に、新しい感覚と新しい問いを立ち上げるための、  
開かれた実験の場であり続けます。
...
映画、舞台、ダンス、映像作品、インスタレーション、パフォーマンスなど、  
表現の背景やコンセプトに深く寄り添いながら、  
作品ごとに固有の音楽を作曲します。  

物語、空間、身体、時間の感覚に耳を澄まし、  
...
AIやアルゴリズムを単なるツールとしてではなく、  
創作の主体性、作者性、判断の所在を問い直す存在として扱います。

新しい技術に対する高揚と違和感の両方を大切にしながら、  
...
研究者、特に **Frederik Bous** との継続的なコラボレーションを通じて、  
音楽・AI・認知・創造性に関する理論と実践の往復を行っています。

Frederik Bous は、  
**IRCAM（Institut de Recherche et Coordination Acoustique/Musique）** にて研究活動を行ってきた研究者であり、  
音楽と人工知能、認知の交差領域を専門としています。

理論を作品へ、作品から新たな問いへとつなぐ往復運動は、  
Studio Cucubits. における制作の方向性そのものを形づくっています。
...
「どんな音がほしいか」だけでなく、  
「なぜこの作品を作るのか」「いま、何が問題なのか」から制作を始めます。
